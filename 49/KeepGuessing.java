...
public class KeepGuessing {
    public static void main(String[] args) {
        ...
        while (entry != code && triesLeft != 1) { // since i put the triesLeft -= 1 at the start of the loop, the condition has to be triesLeft != 1 and not triesLeft != 0. It'll be too late by then :?(S
